...
function isVowel(char) {
  return ["a", "i", "e", "o", "u"].filter((x) => x === char).length > 0
    ? true
    : false;
}
function sum(list) {
...
console.log(
  "Expected output of sum([1,2,3,4]) is 24  " +
...
console.log(
  "Expected output of filterLongWords(['john', 'doe', 'alice','tom'], 3) is ['john', 'alice'] " +
    myFunctionTest(
      2,
      filterLongWords(["john", "doe", "alice", "tom"], 3).length
    )
);
